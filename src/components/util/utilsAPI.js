...
export function getProductsRequest(searchCriteria) {
  ...
  let categoryId = ''
  if (searchCriteria.categoryId !== null && searchCriteria.categoryId !== undefined) {
    categoryId = '&categoryId=' + searchCriteria.categoryId
  }
  let url = BASE_URL + 'products?' + page + size
...
export function getAllOrders(searchCriteria) {
  ...
  let clientId = ''
  if (searchCriteria.userType !== null && searchCriteria.userType === 'ROLE_CLIENT' && searchCriteria.userId !== undefined) {
    clientId = '&clientId=' + Number(searchCriteria.userId)
  }

  if (searchCriteria.userType !== null && searchCriteria.userType === 'ROLE_FLORIST' && searchCriteria.userId !== undefined) {
    clientId = '&floristId=' + Number(searchCriteria.userId)
  }
  ...
  console.log('order final url: ' + url)
